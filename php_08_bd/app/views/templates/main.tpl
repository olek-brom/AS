...
<head>
	...
	<meta name="description" content="{$page_description|default:"Logowanie"}">
...
<div id="app_top" class="header">
    <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
        ...
        <ul>
            <li><a href="{$conf->action_url}logout"  class="pure-menu-link">Wyloguj</a></li>
            <li><a href="{$conf->action_url}resultsList"  class="pure-menu-link">Historia operacji</a></li>
        </ul>
    </div>
</div>
